          ...
          <div>
            <div className="sticky top-0">
              <div className="md:hidden text-center mt-14">
                ...
                <p className="text-black-600 mb-2 ">รุ่นที่10</p>
              </div>
              <img
              ...
              <div className="mt-20 grid grid-cols-3 gap-3 mb-5 text-center">
                <div className="flex flex-col items-center">
                  ...
                  <p className="mt-1 text-xs font-semibold text-black">จัดส่งฟรี</p>
                </div>
                <div className="flex flex-col items-center">
                  <svg
                    viewBox="0 0 35 35"
          ...
          <div className="md:pl-20">
            <div className="mt-14">
              <div className="hidden md:block">
                ...
                <h1 className="text-4xl font-semibold">ซื้อ iPad</h1>
                <p className="text-black-500 mb-2 text-black">(รุ่นที่10)</p>
              </div>
                ...
                <div id="variantAppleCare">
                  ...
                  <div className="mt-3 flex justify-between gap-2 mb-5">
                    <div className="flex gap-2">
                      ...
                      <div>
                        <p className="text-sm font-medium text-black">AppleCare+</p>
                        <p className="text-sm text-black">฿2,590.00</p>
                    ...
                    >
                      <button
                        className="text-sm text-apple-blue cursor-pointer hover:underline"
              ...
              <div className={`pt-5 ${!!variantEngraving ? '' : 'hidden'}`}>
                <div className="mb-4 flex gap-2">
                  ...
                  <p className="text-sm leading-none">
                    <span className="font-bold text-black">การจัดส่ง:</span>
                    <br />
                    <span className='text-black'>4-5 สัปดาห์</span>
                    <br />
                    <span className='text-black'>บริการจัดส่งฟรี</span>
                    <br />
                    <span className="text-apple-blue cursor-pointer hover:underline">
                      ดูวันส่งมอบสินค้า
                    </span>
                ...
                <div className="mb-8 flex gap-2">
                  ...
                  <p className="text-sm leading-none">
                    <span className="font-bold text-black">การรับสินค้า:</span>
                    <br />
      ...
      <>
        ...
        <button onClick={toggleShow} className="block w-full">
          <div className="py-5 flex justify-between items-center hover:text-apple-link-blue">
            ...
            <span className="text-sm text-apple-blue cursor-pointer hover:underline">
              เปลี่ยน
            </span>
          </div>
        </button>
      ...
      <VariantSelection id="variantColor" allowSelect={true}>
        ...
        <div id="variantColorOptions" className="grid grid-cols-2 gap-3">
          ...
          >
            ...
            />
            <p className="mt-2 text-center text-sm text-apple-gray">ฟ้า</p>
          </VariantOption>
          <VariantOption
            variant="color"
            value="pink"
          ...
          >
            <img
              ...
              className="block mx-auto"
            />
            <p className="mt-2 text-center text-sm text-apple-gray">ชมพู</p>
          </VariantOption>
          <VariantOption
            variant="color"
            value="silver"
          ...
          >
            <img
              ...
              className="block mx-auto"
            />
            <p className="mt-2 text-center text-sm text-apple-gray">เงิน</p>
          </VariantOption>
          <VariantOption
            variant="color"
            value="yellow"
          ...
          >
            <img
              ...
              className="block mx-auto"
            />
            <p className="mt-2 text-center text-sm text-apple-gray">เหลือง</p>
          </VariantOption>
        </div>
      </VariantSelection>
    );
    ...
    return (
      <VariantSelection id="variantStorage" allowSelect={allowSelect}>
        ...
        <div className="flex bg-gray-100 rounded-2xl p-5 mb-5">
          <p className="text-xs text-black">
            <span className="font-bold text-black">วางแผนล่วงหน้า เผื่อวันข้างหน้า</span>{' '}
          ...
          <ErrorOutlineIcon className="ml-5 text-apple-blue" />
        </div>
  ...
  if (!show) {
    ...
    return (
      <VariantSelection id="variantType" allowSelect={allowSelect}>
        ...
        <div className="flex bg-gray-100 rounded-2xl p-5 mb-5">
          <p className="text-xs text-black">
            <span className="font-bold text-black">สองวิธีในการต่อติดที่รวดเร็ว</span> iPad
        ...
        <div id="variantTypeOptions" className="grid grid-cols-2 gap-3">
          ...
          >
            <div className="flex flex-col text-center py-1">
              <p>
                <span className="font-medium text-lg text-black">Wi-Fi</span>
              </p>
          ...
          >
            <div className="flex flex-col text-center py-1">
              <p>
                <span className="font-medium text-lg text-black">Wi-Fi + Cellular</span>
              </p>
              <span className="text-xs">
                {!!variantStorage
                  ? `฿${Number(
        ...
        <div id="varaintEngravingOptions" className="space-y-3">
          ...
          >
            <div className="flex justify-between">
              <p className="text-lg font-semibold text-black">เพิ่มการสลัก</p>
              <p className="text-lg text-black">ฟรี</p>
            </div>
          </VariantOption>
          <VariantOption
            variant="engraving"
            ...
            onChange={handleChangeVariantEngraving}
          >
            <p className="text-lg font-semibold text-black">ไม่สลัก</p>
          </VariantOption>
        </div>
      </VariantSelection>
    );
