          ...
          <div>
            <div className="sticky top-0">
              <div className="md:hidden text-center mt-14">
                ...
                <h1 className="text-4xl font-semibold">ซื้อ iPhone 14</h1>
              </div>
              <img
            ...
            <div className="mt-14">
              ...
              <div className="divide-y divide-gray-300">
                <VariantSelection id="variantType" allowSelect={true}>
                  <div className="mb-2">
                    <h4 className="text-xl font-bold">รุ่น</h4>
                  ...
                  <div id="varaintTypeOptions" className="space-y-3">
                    ...
                    >
                      <div className="flex flex-row justify-between items-center">
                        <div>
                          <p className="text-lg font-medium text-black">iPhone 14</p>
                          <p className="text-sm text-black">จอภาพขนาด 6.1 นิ้ว¹</p>
                        </div>
                        <span className="text-right">เริ่มต้นที่ ฿32,900</span>
                      </div>
                    </VariantOption>
                    <VariantOption
                      variant="type"
                    ...
                    >
                      <div className="flex flex-row justify-between items-center">
                        <div>
                          <p className="text-lg font-medium text-black">iPhone 14 Plus</p>
                          <p className="text-sm text-black">จอภาพขนาด 6.7 นิ้ว¹</p>
                        </div>
                        <span className="text-right">เริ่มต้นที่ ฿37,900</span>
                      </div>
                    </VariantOption>
                  </div>
                </VariantSelection>
                ...
                <VariantSelection id="variantColor" allowSelect={!!variantType}>
                  <div className="mb-2">
                    <h4 className="text-xl font-bold">เลือกสีโปรดของคุณ</h4>
                  </div>
                  <div
                  ...
                  >
                    ...
                    >
                      <img
                        src="assets/productVariantColors/iphone14/blue.jpg"
                        alt="variant-color-blue"
                        style={{ maxWidth: '32px' }}
                        className="block mx-auto"
                      />
                      <p className="mt-2 text-center text-sm text-black">ฟ้า</p>
                    </VariantOption>
                    <VariantOption
                      variant="color"
                      value="purple"
                    ...
                    >
                      <img
                        src="assets/productVariantColors/iphone14/purple.jpg"
                        alt="variant-color-purple"
                        style={{ maxWidth: '32px' }}
                        className="block mx-auto"
                      />
                      <p className="mt-2 text-center text-sm text-black">ม่วง</p>
                    </VariantOption>
                    <VariantOption
                      variant="color"
                      value="midnight"
                    ...
                    >
                      <img
                        src="assets/productVariantColors/iphone14/midnight.jpg"
                        alt="variant-color-midnight"
                        style={{ maxWidth: '32px' }}
                        className="block mx-auto"
                      />
                      <p className="mt-2 text-center text-sm text-black">มิดไนท์</p>
                    </VariantOption>
                    <VariantOption
                      variant="color"
                      value="starlight"
                    ...
                    >
                      <img
                        src="assets/productVariantColors/iphone14/starlight.jpg"
                        alt="variant-color-starlight"
                        style={{ maxWidth: '32px' }}
                        className="block mx-auto"
                      />
                      <p className="mt-2 text-center text-sm text-black">สตาร์ไลท์</p>
                    </VariantOption>
                    <VariantOption
                      variant="color"
                      value="red"
                    ...
                    >
                      <img
                        src="assets/productVariantColors/iphone14/red.jpg"
                        alt="variant-color-red"
                        style={{ maxWidth: '32px' }}
                        className="block mx-auto"
                      />
                      <p className="mt-2 text-center text-sm text-black">(PRODUCT)RED</p>
                    </VariantOption>
                  </div>
                </VariantSelection>
