    ...
    <div className="mb-20">
      ...
      <div className="mt-14 hidden lg:block">
        ...
        >
          <div>
            <img
              src="assets/whatsInTheBox/iphone14.jpg"
              className="mx-auto"
              style={{ height: '330px' }}
              alt="WITB iPhone 14"
            />
      ...
      iPhone 14 และ iPhone 14 Plus ไม่มีอะแดปเตอร์แปลงไฟหรือ EarPods ให้มาด้วย ซึ่งเป็นส่วนหนึ่งในความพยายามของเราที่จะไปสู่ {' '}
