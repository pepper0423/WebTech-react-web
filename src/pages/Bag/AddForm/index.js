        ...
        <div className='bg-netflix-black'>
            ...
            <section className='container py-10 mx-auto px-[25%]'>
                ...
                <div className='bg-white py-5 rounded-xl'>
                    ...
                    <form className="w-full max-w-lg mx-auto">
                        ...
                        <div className="flex flex-wrap -mx-3 mb-6">
                            <div className="w-full px-3">
                                <label className="block tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-address">
                                    ที่อยู่
                                </label>
                                ...
                                <p className="text-gray-600 text-xs">หมายเลขหรือชื่ออาคาร, ชื่อถนน</p>
                            </div>
                        </div>
                    ...
                    <AppleButton className="px-28 text-xl block mx-auto mt-8" onClick={() => setShowModal(true)}>
                        ยืนยัน
                    </AppleButton>
                </div>
            </section>
