  ...
  return (
    <FAQAccordion>
      ...
      <QuestionItem>
        ...
        <Answer>
          <p className='text-black leading-normal text-[14px]'>
          iPhone 14, iPhone 14 Plus, iPhone 14 Pro, iPhone 14 Pro Max, iPhone 13 Pro, iPhone 13 Pro Max, iPhone 13, iPhone 13 mini, iPhone 12 และ iPhone 12 mini รองรับ 5G และเมื่อต้องการใช้งาน 5G คุณจะต้องเปิดใช้งาน iPhone กับผู้ให้บริการเครือข่ายที่มีบริการ 5G โดยที่ผู้ให้บริการบางรายอาจกำหนดให้คุณต้องมีแผนบริการ 5G หรือเปลี่ยน SIM ใหม่ โปรดสอบถามข้อมูลเพิ่มเติมจากผู้ให้บริการของคุณ ดูเพิ่มเติมเกี่ยวกับผู้ให้บริการเครือข่ายในประเทศของคุณ{' '}
            <a
