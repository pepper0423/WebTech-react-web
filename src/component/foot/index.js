            ...
            <div className='foot-container'><br />
                <div className='container mx-auto px-64'>
                    <div className='top-foot pb-24 grid grid-cols-5'>
                        <div>
                            <ul>
                                <li className='footer-text text-sm cursor-default'><strong>เลือกซื้อและเรียนรู้</strong></li>
                        ...
                        <div>
                            <ul>
                                <li className='footer-text text-sm cursor-default'><strong>การบริการ</strong></li>
                            ...
                            <ul className='pt-4'>
                                <li className='footer-text text-sm cursor-default'><strong>บัญชี</strong></li>
                        ...
                        <div>
                            <ul>
                                <li className='footer-text text-sm cursor-default'><strong>Apel Store</strong></li>
                        ...
                        <div>
                            <ul>
                                <li className='footer-text text-sm cursor-default'><strong>สำหรับธุรกิจ</strong></li>
                            ...
                            <ul className='pt-4'>
                                <li className='footer-text text-sm cursor-default'><strong>สำหรับการศึกษา</strong></li>
                            ...
                            <ul className='pt-4'>
                                <li className='footer-text text-sm cursor-default'><strong>สำหรับการดูแลสุขภาพ</strong></li>
                                <li><NavLink to='/' className='footer-text text-sm hover:underline'>Apel กับการดูแลสุขภาพ</NavLink></li>
                            </ul>
                        </div>
                        <div>
                            <ul>
                                <li className='footer-text text-sm cursor-default'><strong>เกี่ยวกับ Apel</strong></li>
